        ...
        <VStack align="start" spacing={4} fontSize="md" color="gray.700">
          <Box p={4} bg="nitra.bg" borderRadius="lg" borderWidth="1px" borderColor="rgba(14,74,103,0.18)">
            <HStack spacing={3} mb={1}>
              <Badge bg="nitra.primary" color="white">Indispensabili</Badge>
          ...
          <Box p={4} bg="nitra.bg" borderRadius="lg" borderWidth="1px" borderColor="rgba(14,74,103,0.18)">
            <HStack spacing={3} mb={1}>
              <Badge bg="nitra.accent" color="white">Funzionali</Badge>
          ...
          <Box p={4} bg="nitra.bg" borderRadius="lg" borderWidth="1px" borderColor="rgba(14,74,103,0.18)">
            <HStack spacing={3} mb={1}>
              <Badge bg="nitra.warn" color="white">Terze parti</Badge>
